...
variable "subscription_id" {
  ...
  default     = "4e1a2fb0-7ff7-4dfc-89dd-55e8a7647486"
}

variable "client_id" {
  type        = "string"
  description = "Client ID for Azure"
  default     = "4cbdd08e-ecb7-49fb-9ade-11069320bf34"  
}

variable "client_secret" {
  type        = "string"
  description = "Client Secret for Azure"
  default     = "da2b89ce-58f9-4136-8efa-a4c8138225a5"
}

variable "tenant_id" {
  type        = "string"
  description = "Tenent ID for Azure"
  default     = "fc5be58e-67a5-4d7f-88f6-abf551a10766"
}